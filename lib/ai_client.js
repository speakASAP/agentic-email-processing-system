...
// Ingest is rule-based only; answer in <1s when unreachable (no retry)
const INGEST_TIMEOUT_MS = Math.min(5000, Math.max(1000, parseInt(process.env.AI_INGEST_TIMEOUT_MS || '1000', 10) || 1000));
