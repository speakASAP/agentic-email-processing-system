# Copilot Instructions — `agentic-email-processing-system`
...
- **Authoritative path**: `/home/ssf/Documents/Github/agentic-email-processing-system` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/agentic-email-processing-system.git`, branch `main`.
